...
Do NOT give medical diagnoses. Do NOT claim certainty.

Write SHORT output. Keep total length under ~1800 characters.
...
Recent history (last \(min(14, input.history.count)) days):
\(historyLines)
